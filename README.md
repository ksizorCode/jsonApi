...
A partir de este respositorio (instalalo en tu Local), crea un frontend en HTML, CSS y JS que lea la api y muestre la info de una forma bonita.
...
Por el momento haz las peticiones en local, luego subiré el contenido a un FTP para probarlo.
